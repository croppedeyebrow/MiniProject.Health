...
public class JoinMemberVo {
    ...
    public JoinMemberVo(String user_id, String user_pw, String user_name, int user_birth, double user_height, double user_weight, double user_goal_weight, Timestamp user_created_on) {
        this.user_id = user_id;
        this.user_pw = user_pw;
        this.user_name = user_name;
        this.user_birth = user_birth;
